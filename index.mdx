...
<CardGroup cols={2}>
  ...
  <Card title="Your personal brain" icon="lock" href="/brains/your-personal-brain">
    Why everything you capture is private by default, permanently.
  </Card>
...
1. **Everything you capture lands somewhere only you can see.** Your personal brain cannot be shared, ever. Ambient capture (agent conversations, quick uploads, connected tools) defaults there.
2. **Nothing reaches a shared brain by accident.** Writing to a brain your team can see is always a deliberate act: a connection you approved, into a brain you chose.
