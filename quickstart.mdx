...
By the end of this page you will have a Cortex account, something filed in your personal brain, and an AI agent that can recall it.
...
<Steps>
  ...
  <Step title="Meet your personal brain">
    Open **Brains**. You already have one, called **Personal**. It was created with your account, it is private to you, and it always will be: it cannot be shared, and it cannot be deleted. This is where everything you capture lands unless you deliberately send it somewhere else.
  </Step>

  <Step title="Capture your first item">
    Open your Personal brain and go to its **Inbox**. Drag in a file: meeting notes, a PDF, a Word document, anything with words in it. It appears in the inbox as a new item, with its text extracted and ready to file.
  ...
  <Step title="Connect your agent">
    Open your Personal brain's **Connect** page. You will see a connection URL that is specific to this brain. Add it to your AI tool:
    ...
    The approval screen names the brain and the access level, so you always know exactly what you are granting. One connection reaches exactly one brain.
  </Step>

  <Step title="Ask your agent to remember">
    In your agent, ask something like *"Search my brain for what I uploaded earlier"* or *"What do you know about me so far?"*. The agent searches your Personal brain and answers with what it finds, citing the pages it read.
